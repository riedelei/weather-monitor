...
public class CityService {
    ...
    private void setUrlWithLatLon(String city) {
        this.placesUrl = this.placesUrl.concat(city).concat(
                "&limit="+OpenWeatherConst.LIMIT.FUNF.getValue()+"&appid="+OpenWeatherConst.APIKEY2);
    }

    private void setUrlWithLatLonForOneCity(String city) {
        this.placesUrl = this.placesUrl.concat(city).concat(
                "&limit="+OpenWeatherConst.LIMIT.EINS.getValue()+"&appid="+ OpenWeatherConst.APIKEY2);
    }
}
